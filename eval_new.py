...
if __name__ == "__main__":
    ...
    for shots in shot_sg:
        ...
        for n_type in nts:
            ...
            with tqdm(test_loader) as it:
                for batch_no, (clean_batch, noisy_batch) in enumerate(it, start=1):
                    ...
                    clean_numpy_list.append(clean_numpy)
                    noise_numpy_list.append(noisy_numpy)
                    out_numpy_list.append(out_numpy)
        ...
        for idx_seg in range(len(segs) - 1):
            ...
            print(
                '******************' + str(segs[idx_seg]) + '< noise <' + str(segs[idx_seg + 1]) + '******************')
